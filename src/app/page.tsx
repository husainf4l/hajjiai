    ...
    <div className="min-h-screen bg-[#2d3142] flex flex-col">
      ...
      <header className="bg-[#121215] p-4 text-white shadow-md flex items-center justify-between">
        ...
        <div className="flex items-center text-sm text-gray-400">
          ...
          <span>Prototype access closes at 4:00 PM</span>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-8">
        <div className="max-w-3xl w-full bg-[#1c1e26] rounded-lg shadow-xl overflow-hidden scale-in">
          ...
          <div className="p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-white mb-4 fade-in">Welcome to the Albilsan Group Chat</h1>
            <p className="text-gray-400 text-lg mb-8 fade-in" style={{ animationDelay: "0.1s" }}>
              This prototype demonstrates our interactive chat interface with sales data visualization 
              and dynamic reporting features.
            </p>
            <Link 
              href="/chat" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-700">
            <div className="p-6 text-center slide-in-right" style={{ animationDelay: "0.1s" }}>
              ...
              <p className="text-gray-400">Interactive tables and formatted data presentation</p>
            </div>
            <div className="p-6 text-center slide-in-right" style={{ animationDelay: "0.2s" }}>
              <div className="bg-[#121215] rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-400">Smooth scrolling and animated chat interactions</p>
            </div>
            <div className="p-6 text-center slide-in-right" style={{ animationDelay: "0.3s" }}>
              <div className="bg-[#121215] rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-400">Analytics and formatted business insights</p>
            </div>
          </div>

          {/* Notice */}
          <div className="p-6 bg-[#121215] text-center fade-in" style={{ animationDelay: "0.5s" }}>
